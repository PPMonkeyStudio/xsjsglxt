	...
	var jc = $
			.confirm({
				...
				content : '<table class="table table-hover table-bordered"><tbody>'
						...
						+ '<input type="radio" name="input_case_territorial"  value="本地">'
						+ '本地'
						+ '</label> '
						...
						+ '<input type="radio" name="input_suspecter_sex"  value="男">'
						+ '男'
						+ '</label> '
						+ ' <label style="margin:0 10px;" >'
				...
				buttons : {
					修改 : function() {
						...
						xhr
								.open("POST",
										"/xsjsglxt/ContrastFingerPrint/ContrastFingerPrintManagement_modifiedContrast");
						xhr.send(formData);
					...
					for (var num = 0; num < contrastFingerPrint_VO.list_xsjsglxt_contrast_fingerprint.length; num++) {
						...
						if (contrastFingerPrint_id == button_id) {
							...
							for (var i = 0; i < input_case_territorial.length; i++) {
								...
								} else if (input_case_territorial_value == "外地") {
									input_case_territorial[1].checked = "checked";
								} else {
							...
							input_suspecter_name.value = contrastFingerPrint_VO.list_xsjsglxt_contrast_fingerprint[num].contrast_fingerprint_suspecter_name;
							// 性别（单选框）
							var input_suspecter_sex = document
									.getElementsByName("input_suspecter_sex");
							...
							// 出生日期
							var input_suspecter_birthday = document
									.getElementById("input_suspecter_birthday");
							input_suspecter_birthday.value = contrastFingerPrint_VO.list_xsjsglxt_contrast_fingerprint[num].contrast_fingerprint_suspecter_birthday;
							// 身份证号码
							var input_suspecter_identity = document
									.getElementById("input_suspecter_identity");
							...
							// 户籍地
							var input_suspecter_domicile = document
									.getElementById("input_suspecter_domicile");
							input_suspecter_domicile.value = contrastFingerPrint_VO.list_xsjsglxt_contrast_fingerprint[num].contrast_fingerprint_suspecter_domicile;
							// 现住址
							var input_present_address = document
									.getElementById("input_present_address");
							input_present_address.value = contrastFingerPrint_VO.list_xsjsglxt_contrast_fingerprint[num].contrast_fingerprint_present_address;
							// 按印部门
							var input_press_department = document
									.getElementById("input_press_department");
							input_press_department.value = contrastFingerPrint_VO.list_xsjsglxt_contrast_fingerprint[num].contrast_fingerprint_press_department;
							// 提取部门
							var input_extract_department = document
									.getElementById("input_extract_department");
							input_extract_department.value = contrastFingerPrint_VO.list_xsjsglxt_contrast_fingerprint[num].contrast_fingerprint_extract_department;
							// 按印人
							var input_fingerprint_presser = document
									.getElementById("input_fingerprint_presser");
							input_fingerprint_presser.value = contrastFingerPrint_VO.list_xsjsglxt_contrast_fingerprint[num].contrast_fingerprint_presser;
							// 按印时间
							var input_press_time = document
									.getElementById("input_press_time");
							input_press_time.value = contrastFingerPrint_VO.list_xsjsglxt_contrast_fingerprint[num].contrast_fingerprint_press_time;
							// 提取人
							var input_fingerprint_extracter = document
									.getElementById("input_fingerprint_extracter");
							input_fingerprint_extracter.value = contrastFingerPrint_VO.list_xsjsglxt_contrast_fingerprint[num].contrast_fingerprint_extracter;
							// 指位
							var input_fingerprint_fingerposition = document
									.getElementById("input_fingerprint_fingerposition");
							input_fingerprint_fingerposition.value = contrastFingerPrint_VO.list_xsjsglxt_contrast_fingerprint[num].contrast_fingerprint_fingerposition;
							// 对比单位
							var input_contrast_organization = document
									.getElementById("input_contrast_organization");
							input_contrast_organization.value = contrastFingerPrint_VO.list_xsjsglxt_contrast_fingerprint[num].contrast_fingerprint_contrast_organization;
							// 对比人
							var input_fingerprint_contraster = document
									.getElementById("input_fingerprint_contraster");
							input_fingerprint_contraster.value = contrastFingerPrint_VO.list_xsjsglxt_contrast_fingerprint[num].contrast_fingerprint_contraster;
							// 复核人
							var input_fingerprint_reviewer = document
									.getElementById("input_fingerprint_reviewer");
							input_fingerprint_reviewer.value = contrastFingerPrint_VO.list_xsjsglxt_contrast_fingerprint[num].contrast_fingerprint_reviewer;
							// 抓获单位
							var input_arrested_organization = document
									.getElementById("input_arrested_organization");
							input_arrested_organization.value = contrastFingerPrint_VO.list_xsjsglxt_contrast_fingerprint[num].contrast_fingerprint_arrested_organization;
							// 抓获时间
							var input_arrested_time = document
									.getElementById("input_arrested_time");
							input_arrested_time.value = contrastFingerPrint_VO.list_xsjsglxt_contrast_fingerprint[num].contrast_fingerprint_arrested_time;
							// 联系电话
							var input_contract_number = document
									.getElementById("input_contract_number");
							input_contract_number.value = contrastFingerPrint_VO.list_xsjsglxt_contrast_fingerprint[num].contrast_fingerprint_contract_number;
							// 备注
							var textarea_fingerprint_remark = document
