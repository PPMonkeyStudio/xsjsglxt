				...
				buttons : {
					...
					确定 : {
						action : function() {
							// 判断身份证是否为空
							var ID = document
									.getElementsByName("policeman.staff_idNumber")[0].value;
							var name = document
									.getElementsByName("policeman.xsjsglxt_name")[0].value;
							var policeTime = document
									.getElementsByName("policeman.staff_thePoliceTime")[0].value;
							var alarm = document
									.getElementsByName("policeman.staff_alarm")[0].value;
							if (ID == "" || name == "" || policeTime == ""
									|| alarm == "") {
...
function studyExp_ajax(url, id) {
	...
	// 得到每行
	var s_tr = document.getElementById("studyExperience_table")
...
function workExp_ajax(id) {
	...
	var formdata = new FormData();
	// 得到每行
	var w_tr = document.getElementById("wordExperience_table")
			.getElementsByTagName("tr");
...
function add_studyExperience() {
	...
	// 把表格的数据存到json中
	var staffStudent_evection = document
			.querySelector(".staffStudent_evection").value;
	var staffStudent_address = document.querySelector(".staffStudent_address").value;
	var staffStudent_startTime = document
			.querySelector(".staffStudent_startTime").value;
	var staffStudent_stopTime = document
			.querySelector(".staffStudent_stopTime").value;
	var staffStudent_remarks = document.querySelector(".staffStudent_remarks").value;
	newStudyExp['staffStudent_evection'] = staffStudent_evection;
	...
	var staffStudent_evection = document.createElement("td");
	staffStudent_evection.innerHTML = newStudyExp['staffStudent_evection'];
	staffStudent_evection.setAttribute("name", "students[" + i
			+ "].staffStudent_evection");

	var staffStudent_address = document.createElement("td");
	staffStudent_address.innerHTML = newStudyExp['staffStudent_address'];
	staffStudent_address.setAttribute("name", "students[" + i
			+ "].staffStudent_address");
	...
	study_tr.appendChild(staffStudent_evection);
...
function add_workExperience() {
	...
	// 动态创建表格
	var wordExperience_table = document.getElementById("wordExperience_table");
	...
	staffWork_address
			.setAttribute("name", "works[" + w + "].staffWork_address");
...
function add_family() {
	...
	// 把表格的数据存到json中
	var staffFamily_contactsRelationship = document
			.querySelector(".staffFamily_contactsRelationship").value;
	...
	var staffFamily_workSpace = document
			.querySelector(".staffFamily_workSpace").value;
	...
	staffFamily_contactsRelationship.setAttribute("name", "familys[" + f
...
function add_policeChange() {
	...
	staffMove_outTime
			.setAttribute("name", "moves[" + p + "].staffMove_outTime");
	...
	staffMove_remarks
			.setAttribute("name", "moves[" + p + "].staffMove_remarks");
...
function add_prized() {
	...
	// 把表格的数据存到json中
	var staffReward_situation = document
			.querySelector(".staffReward_situation").value;
	...
	staffReward_situation.setAttribute("name", "rewards[" + pr
...
function add_AgainstPrinciple() {
	...
	// 把表格的数据存到json中
	var staffPrinciple_situation = document
			.querySelector(".staffPrinciple_situation").value;
	var staffPrinciple_Time = document.querySelector(".staffPrinciple_Time").value;
	var staffPrinciple_remarks = document
			.querySelector(".staffPrinciple_remarks").value;
	...
	staffPrinciple_situation.setAttribute("name", "principles[" + a
			+ "].staffPrinciple_situation");
	...
	staffPrinciple_Time.setAttribute("name", "principles[" + a
			+ "].staffPrinciple_Time");

	var staffPrinciple_remarks = document.createElement("td");
	staffPrinciple_remarks.innerHTML = newStudyExp['staffPrinciple_remarks'];
	staffPrinciple_remarks.setAttribute("name", "principles[" + a
			+ "].staffPrinciple_remarks");
...
function add_Vocation() {
	...
	// 把表格的数据存到json中
	var staffFurlough_mainContent = document
			.querySelector(".staffFurlough_mainContent").value;
	var staffFurlough_startTime = document
			.querySelector(".staffFurlough_startTime").value;
	var staffFurlough_days = document.querySelector(".staffFurlough_days").value;
	var staffFurlough_whetherStop = document
			.querySelector(".staffFurlough_whetherStop").value;
	var staffFurlough_stopTime = document
			.querySelector(".staffFurlough_stopTime").value;
	var staffFurlough_remarks = document
			.querySelector(".staffFurlough_remarks").value;
	...
	staffFurlough_mainContent.setAttribute("name", "furloughs[" + v
			+ "].staffFurlough_mainContent");
	...
	staffFurlough_startTime.setAttribute("name", "furloughs[" + v
			+ "].staffFurlough_startTime");

	var staffFurlough_days = document.createElement("td");
	staffFurlough_days.innerHTML = newStudyExp['staffFurlough_days'];
	staffFurlough_days.setAttribute("name", "furloughs[" + v
			+ "].staffFurlough_days");
...
function getAge() {
	...
	var sex_man = document.getElementsByName("policeman.xsjsglxt_sex")[0];
	var sex_woman = document.getElementsByName("policeman.xsjsglxt_sex")[1];
	// 根据身份证得到性别
	...
	document.querySelector(".staff_birthday").value = year + "-" + month + "-"
			+ date;
	// 根据身份证得到年龄
	var myDate = new Date();
