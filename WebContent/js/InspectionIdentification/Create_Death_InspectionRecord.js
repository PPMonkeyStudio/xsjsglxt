...
function addDeathInspectionRecord(jc) {
	...
	var create_death_inspection_record_anatomy_picture2 = document.getElementById("create_death_inspection_record_anatomy_picture2");
	var create_death_inspection_record_anatomy_picture3 = document.getElementById("create_death_inspection_record_anatomy_picture3");

	if (create_death_inspection_record_autopsy_table_test_picture1.files[0] == null && create_death_inspection_record_autopsy_table_test_picture2.files[0] == null
			&& create_death_inspection_record_autopsy_table_test_picture3.files[0] == null && create_death_inspection_record_anatomy_picture1.files[0] == null
			&& create_death_inspection_record_anatomy_picture2.files[0] == null && create_death_inspection_record_anatomy_picture3.files[0] == null) {
