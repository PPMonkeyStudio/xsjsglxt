	...
	var jc = $
			.confirm({
				...
				content : '<form id="form_AppraisalLetter"><input value="'
						...
						+ '</tr>'
						+ '<tr>'
						+ '<td rowspan="2">鉴定人：</td><td>姓名：</td><td><input class="form-control" name=""/></td><td>职务：</td><td><input class="form-control" name=""/></td>'
						+ '</tr>'
						+ '<tr>'
						+ '<td>姓名：</td><td><input class="form-control" name=""/></td><td>职务：</td><td><input class="form-control" name=""/></td>'
						+ '</tr>'
						+ '<tr>'
						+ '<td >授权签字人：</td><td>姓名：</td><td><input class="form-control" name=""/></td><td>职务：</td><td><input class="form-control" name=""/></td>'
