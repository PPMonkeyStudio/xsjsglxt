			...
			.confirm({
				...
				onContentReady : function() {
					...
					case "整体分离检验鉴定": {
						//
						document
								.getElementsByName("inspectionRecord.inspection_check_material_situation")[0].value = '检材是XXXX';
						//
						document
								.getElementsByName("inspectionRecord.inspection_sample_situation")[0].value = '样本是XXXX';
						//
						document
								.getElementsByName("inspectionRecord.inspection_method")[0].value = 'IFSC 06-05-01-2006（整体分离鉴定法）';
						//
						document
								.getElementsByName("inspectionRecord.inspection_process")[0].value = '      比较检验检材与样本发现两者颜色、质地、新旧程度及灰尘附着情形相同。将检材与样本的分离缘进行拼接，分离缘凹凸互补，一一对应，分离线相互吻合'
								+ '\n      检材与样本的颜色、质地和新旧程度相同，分离缘吻合完好，具有排它性，两者原属于同一整体。';
						//
						document
								.getElementsByName("inspectionRecord.inspection_option")[0].value = '送检的XXXXX与XXXXX是同一整体。';
						break;
					}
					case "车辆痕迹检验鉴定": {
						//
						...
						//
						document
								.getElementsByName("inspectionRecord.inspection_method")[0].value = 'IFSC 06-02-02-2006（车体痕迹鉴定法）';
						//
						document
								.getElementsByName("inspectionRecord.inspection_process")[0].value = '      （一）XXXXX是一辆XXXXX车，长X、宽X、高X、重X、发动机号X，对XX车的检验发现：'
