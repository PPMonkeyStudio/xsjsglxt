...
var createScheduling = function() {
	$
			.confirm({
				...
				type : 'green',
				content : '<table class="table bordered-table"><tr><td>带班领导：</td><td style="text-align:center;" class="loadingLay"><i class="fa fa-spinner fa-spin fa-3x fa-fw"></i></td><td class="contentName" style="display:none;"><select data-selected-text-format="count > 8" id="leader" style="width: 250px;" class="form-control selectpicker" data-live-search="true" multiple title="请选择主班领导"></select></td></tr>'
						+ '<tr><td>侦查民警：</td><td class="loadingLay" style="text-align:center;"><i class="fa fa-spinner fa-spin fa-3x fa-fw"></i></td></td><td class="contentName" style="display:none;"><select data-selected-text-format="count > 8" id="main" style="width: 250px;" class="form-control selectpicker" data-live-search="true" multiple title="请选择侦查民警"></select></td></tr>'
						+ '<tr><td>技术民警：</td><td class="loadingLay" style="text-align:center;"><i class="fa fa-spinner fa-spin fa-3x fa-fw"></i></td></td><td class="contentName" style="display:none;"><select data-selected-text-format="count > 8" id="mainTech" style="width: 250px;" class="form-control selectpicker" data-live-search="true" multiple title="请选择技术民警"></select></td></tr>'
						+ '<tr><td>辅警：</td><td class="loadingLay" style="text-align:center;"><i class="fa fa-spinner fa-spin fa-3x fa-fw"></i></td><td class="contentName" style="display:none;"><select data-selected-text-format="count > 8" id="assistant" style="width: 250px;" class="form-control selectpicker" data-live-search="true" multiple title="请选择辅警"></select></td></tr>'
