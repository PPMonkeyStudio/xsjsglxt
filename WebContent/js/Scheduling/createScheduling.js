...
var chooseStaff = function(inputId) {
	$
			.confirm({
				...
				type : 'red',
				content : ''
						+ '<select onchange="changeDuty(this)" name="query_auty" class="form-control" style="float:left; width: 200px; margin-bottom: 10px;">'
						+ '<option value="">全部</option><option value="侦查">侦查</option><option value="技术">技术</option></select>'
						+ '<select onchange="changeDuty(this)" name="query_duty" class="form-control" style="float:top; width: 200px; margin-bottom: 10px;">'
...
var changeDuty = function(event) {
	chooseStaffParams[event.name] = event.value;
	$
			.ajax({
				type : 'POST',
				url : '/xsjsglxt/team/Staff_getAllStaff',
				data : chooseStaffParams,
				success : function(data) {
					var jsonData = JSON.parse(data);
					var str = '';
					for (var int = 0; int < jsonData.length; int++) {
	...
	$
			.confirm({
				...
				content : '<table class="table bordered-table" style="text-align:center;">'
						+ '<tr><td>带班领导：</td><td   class="contentName"><input id="leader" style="width: 250px;" class="form-control" readonly="true"></td><td colspan="2" style="text-align:left;"><button onclick="chooseStaff(\'leader\')" class="btn btn-default"><i class="fa fa-plus-square"></i>添加</button></td></tr>'
						+ '<tr><td>侦查民警：</td><td  class="contentName"><input id="main" style="width: 250px;" class="form-control" readonly="true"></td><td colspan="2" style="text-align:left;"><button onclick="chooseStaff(\'main\')" class="btn btn-default"><i class="fa fa-plus-square"></i>添加</button></td></tr>'
						+ '<tr><td>技术民警：</td><td class="contentName"><input id="mainTech" style="width: 250px;" class="form-control" readonly="true"></td><td colspan="1" style="text-align:left;"><button onclick="chooseStaff(\'mainTech\')" class="btn btn-default"><i class="fa fa-plus-square"></i>添加</button></td><td><select class="form-control" id="personNumber"><option value="1">单人</option><option value="2">双人</option></select></td></tr>'
						+ '<tr><td>法医民警：</td><td  class="contentName"><input id="mainDoctor" style="width: 250px;" class="form-control" readonly="true"></td><td colspan="2" style="text-align:left;"><button onclick="chooseStaff(\'mainDoctor\')" class="btn btn-default"><i class="fa fa-plus-square"></i>添加</button></td></tr>'
						+ '<tr><td>侦查辅警：</td><td  class="contentName"><input id="assistantSpy" style="width: 250px;" class="form-control" readonly="true"></td><td colspan="2" style="text-align:left;"><button onclick="chooseStaff(\'assistantSpy\')" class="btn btn-default"><i class="fa fa-plus-square"></i>添加</button></td></tr>'
						+ '<tr><td>技术辅警：</td><td  class="contentName"><input id="assistantTech" style="width: 250px;" class="form-control" readonly="true"></td><td colspan="2" style="text-align:left;"><button onclick="chooseStaff(\'assistantTech\')" class="btn btn-default"><i class="fa fa-plus-square"></i>添加</button></td></tr>'
