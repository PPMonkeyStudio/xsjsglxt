			...
			<div class="panel-body">
				<div class="operation" style="margin-bottom: 6px;">
					...
					<button style="margin-left: 15px;" type="button"
						...
						onclick="javascript:location.href='/xsjsglxt/team/saveStaff'">
					...
					<div class="panel">
						...
						<div class="panel-body">
							<table class="table table-hover table-condensed staff_table_info">
								...
								<tfoot>
									<tr>
										<td colspan="11" style="font-size: 12px;" class="page_info">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
							...
							<tbody>
								<tr>
									<td><label class="staff_info_label">姓名</label> <input
										type="text" class="staff_info_input" name="page_list_staffInformation.staff_name" /></td>
								</tr>
								<tr>
									<td><label class="staff_info_label">性别</label>
									 <select name="page_list_staffInformation.staff_sex"
								...
								<tr>
									<td><label class="staff_info_label">政治面貌</label>
									 <select  name="page_list_staffInformation.staff_politicalStatus"
										class="staff_info_input">
											<option>1</option>
											<option>团员</option>
											<option>群众</option>
								...
								<tr>
									<td><label class="staff_info_label">入警时间</label>
									 <input name="page_list_staffInformation.start_time"
										type="text" class="staff_info_input" />&nbsp;&nbsp;到
										<input name="page_list_staffInformation.stop_time"
										type="text" class="staff_info_input" /></td>
								</tr>
							</tbody>
						</table>
					</form>
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" onclick="iquery()" data-dismiss='modal'>查询</button>
				</div>
			</div>
		</div>
	</div>
