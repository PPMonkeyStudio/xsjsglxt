...
table tr th {
	...
	height: 42px;
	word-break: break-all; /* 设置自动换行切不挤压其他td给td设置了宽度时有效 */
	white-space:normal;
}
...
<body>
	...
	<table id="tableContent"
		style="text-align: center; width: 1200px; margin: 0 auto; margin-bottom: 20px;">
		<tr style="border-top: none; border-left: none; border-right: none;">
			<td colspan="6"
				style="border-top: none; border-left: none; border-right: none;"><h3>案件信息</h3></td>
		</tr>
		<tr>
			<td>案件名称</td>
		...
		<tr style="border-top: none; border-left: none; border-right: none;">
			<td colspan="6"
				style="border-top: none; border-left: none; border-right: none;"><h3>报案人信息</h3></td>
		</tr>
		<tr>
			<td>姓名</td>
		...
		<tr style="border-top: none; border-left: none; border-right: none;">
			<td colspan="6"
				style="border-top: none; border-left: none; border-right: none;"><h3>基站信息</h3></td>
		</tr>
		<tr>
			<td>移动基站号</td>
		...
		<tr style="border-top: none; border-left: none; border-right: none;">
			<td colspan="6"
				style="border-top: none; border-left: none; border-right: none;"><h3>物证信息</h3></td>
		</tr>
		<tr>
		...
		<tr style="border-top: none; border-left: none; border-right: none;">
			<td colspan="6"
				style="border-top: none; border-left: none; border-right: none;"><h3>丢失物品信息</h3></td>
		</tr>
		<tr>
		...
		<tr style="border-top: none; border-left: none; border-right: none;">
			<td colspan="6"
				style="border-top: none; border-left: none; border-right: none;"><h3>丢失电脑信息</h3></td>
		</tr>
		<tr>
			<td>电脑品牌</td>
			<td>上网账号</td>
		...
		<tr style="border-top: none; border-left: none; border-right: none;">
			<td colspan="6"
				style="border-top: none; border-left: none; border-right: none;"><h3>丢失手机信息</h3></td>
		</tr>
		<tr>
			<td>手机号码</td>
			<td>手机串号</td>
		...
		<tr style="border-top: none; border-left: none; border-right: none;">
			<td colspan="6"
				style="border-top: none; border-left: none; border-right: none;"><h3>照片信息</h3></td>
		</tr>
		<tr>
