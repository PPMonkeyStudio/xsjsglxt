...
<script type="text/javascript"
	src="<%=basePath%>js/memorabilia/createMemorabilia.js"></script>
<script type="text/javascript"
	src="<%=basePath%>js/memorabilia/showMemorabilia.js"></script>
<script type="text/javascript"
	src="<%=basePath%>js/memorabilia/managerMemorabilia.js"></script>
</head>
<body>
		...
		<div class="panel"
			...
			<div class="headDiv" style="padding-top: 10px;">
				<button class="btn btn-default managerRole"
					...
					<i class="fa fa-pencil-square-o"></i>填写大事记
				</button>

				<div id="query" style="float: right;">
					<label>时间筛选</label> <input class="form-control startTime"
						onchange="changeTime(this)" type="text" id="timeStart"
						style="width: 150px; display: inline-block;">至 <input
						class="form-control startTime" onchange="changeTime(this)"
						...
						oninput="changeSearchContent(this)" placeholder="请输入搜索内容">
				</div>
			</div>
