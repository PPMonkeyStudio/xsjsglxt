...
public class ResevidenceInformationDTO {
	...
	private List<xsjsglxt_circulation> circulation;
	...
	public List<xsjsglxt_circulation> getCirculation() {
		return circulation;
	}

	public void setCirculation(List<xsjsglxt_circulation> circulation) {
