...
public xsjsglxt_snece(String xsjsglxt_snece_id, String snece_case, String snece_inquestId, String snece_inquestSystemId,
		String snece_mobileStation, String snece_mobileVillage, String snece_unicomSwitchboard,
		String snece_unicomVillage, String snece_telecomStation, String snece_weather, String snece_weatherTemperature,
		String snece_inquestPerson, String snece_fillPerson, String snece_fillUnit, String snece_fillTime,
		int snece_photographed, int snece_entered, int snece_areadymade, int snece_parsed, int snece_archived,
		int snece_identified, String snece_gmt_create, String snece_gmt_modified) {
...
public String toString() {
	return "snece [xsjsglxt_snece_id=" + xsjsglxt_snece_id + ", snece_case=" + snece_case + ", snece_inquestId="
			...
			+ ", snece_photographed=" + snece_photographed + ", snece_entered=" + snece_entered + ", snece_areadymade="
			+ snece_areadymade + ", snece_parsed=" + snece_parsed + ", snece_archived=" + snece_archived
			+ ", snece_identified=" + snece_identified + ", snece_gmt_create=" + snece_gmt_create
