...
public class xsjsglxt_handle {
	...
	public String toString() {
		return "xsjsglxt_handle [xsjsglxt_handle_id=" + xsjsglxt_handle_id + ", handle_orderNumber="
				+ handle_orderNumber + ", handle_administrativeCase=" + handle_administrativeCase
				+ ", handle_suspectName=" + handle_suspectName + ", handle_administrativeAttachment="
				+ handle_administrativeAttachment + ", handle_arrest=" + handle_arrest + ", handle_prosecute="
				+ handle_prosecute + ", handle_checkback=" + handle_checkback + ", handle_pbat=" + handle_pbat
				+ ", handle_lhus=" + handle_lhus + ", handle_StartTimeaOfDetention=" + handle_StartTimeaOfDetention
				+ ", handle_arrestTime=" + handle_arrestTime + ", handle_prosecuteTime=" + handle_prosecuteTime
				+ ", handle_checkbackTime=" + handle_checkbackTime + ", handle_pbatTime=" + handle_pbatTime
				+ ", handle_lhusTime=" + handle_lhusTime + ", handle_detentionDay=" + handle_detentionDay
