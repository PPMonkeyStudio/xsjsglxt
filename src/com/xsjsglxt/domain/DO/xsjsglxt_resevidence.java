...
public class xsjsglxt_resevidence {
	...
	private String resevidence_sendstate;// 送检状态
	...
	public String toString() {
		return "xsjsglxt_resevidence [xsjsglxt_resevidence_id=" + xsjsglxt_resevidence_id + ", resevidence_case="
				...
				+ ", resevidence_remarks=" + resevidence_remarks + ", resevidence_circulation="
				+ resevidence_circulation + ", resevidence_teststate=" + resevidence_teststate
				+ ", resevidence_gmt_create=" + resevidence_gmt_create + ", resevidence_gmt_modified="
				+ resevidence_gmt_modified + "]";
	}
	...
	public String getResevidence_sendstate() {
		return resevidence_sendstate;
	}

	public void setResevidence_sendstate(String resevidence_sendstate) {
		this.resevidence_sendstate = resevidence_sendstate;
	}

	public String getResevidence_savePlace() {
		return resevidence_savePlace;
	}

	public void setResevidence_savePlace(String resevidence_savePlace) {
		this.resevidence_savePlace = resevidence_savePlace;
	}
