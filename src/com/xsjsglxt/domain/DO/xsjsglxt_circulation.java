...
public class xsjsglxt_circulation {
	...
	public xsjsglxt_circulation(String xsjsglxt_circulation_id, String circulation_resevidence,
			String circulation_situation, String circulation_position, String circulation_date,
			String circulation_transferperson, String circulation_recipient, String circulation_gmt_create,
			String circulation_gmt_modified) {
	...
	public String toString() {
		return "circulation [xsjsglxt_circulation_id=" + xsjsglxt_circulation_id + ", circulation_resevidence="
				+ circulation_resevidence + ", circulation_situation=" + circulation_situation
				+ ", circulation_position=" + circulation_position + ", circulation_date=" + circulation_date
				+ ", circulation_transferperson=" + circulation_transferperson + ", circulation_recipient="
				+ circulation_recipient + ", circulation_gmt_create=" + circulation_gmt_create
				+ ", circulation_gmt_modified=" + circulation_gmt_modified + "]";
	}
