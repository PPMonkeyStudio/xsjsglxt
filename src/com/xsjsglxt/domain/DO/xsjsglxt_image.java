...
public xsjsglxt_image(String xsjsglxt_image_id, String image_remarks, String image_gmt_create, String image_gmt_modified) {
...
public String toString() {
	return "image [xsjsglxt_image_id=" + xsjsglxt_image_id + ", image_remarks=" + image_remarks + ", image_gmt_create="
			+ image_gmt_create + ", image_gmt_modified=" + image_gmt_modified + "]";
}
