...
public class xsjsglxt_breakecase {
	...
	public String toString() {
		return "xsjsglxt_breakecase [xsjsglxt_breakecase_id=" + xsjsglxt_breakecase_id + ", breakecase_type="
				+ breakecase_type + ", breakecase_case=" + breakecase_case + ", breakecase_suspectName="
				+ breakecase_suspectName + ", breakecase_suspectSex=" + breakecase_suspectSex
				+ ", breakecase_suspectBirthday=" + breakecase_suspectBirthday + ", breakecase_suspectIDnum="
				+ breakecase_suspectIDnum + ", breakecase_suspectAddress=" + breakecase_suspectAddress
				+ ", breakecase_according=" + breakecase_according + ", breakecase_capture=" + breakecase_capture
				+ ", breakecase_captureUnit=" + breakecase_captureUnit + ", breakecase_waitbreakecase="
