...
public class xsjsglxt_appraisal_letter {
	...
	public String toString() {
		return "xsjsglxt_appraisal_letter [xsjsglxt_appraisal_letter_id=" + xsjsglxt_appraisal_letter_id + ", appraisal_letter_belong_entrustment_book="
				+ appraisal_letter_belong_entrustment_book + ", appraisal_letter_inspection=" + appraisal_letter_inspection + ", appraisal_letter_argumentation="
				+ appraisal_letter_argumentation + ", appraisal_letter_expert_opinion=" + appraisal_letter_expert_opinion + ", appraisal_letter_gmt_create="
