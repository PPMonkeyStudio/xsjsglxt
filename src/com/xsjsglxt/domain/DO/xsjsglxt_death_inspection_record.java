...
public class xsjsglxt_death_inspection_record {
	private String xsjsglxt_death_inspection_record_id;
	private String death_inspection_record_belong_entrustment_book;
	private String death_inspection_record_undertake_personnel;
	private String death_inspection_record_phone;
	private String death_inspection_record_death_name;
	private String death_inspection_record_death_sex;
	private String death_inspection_record_death_birth_date;
	private String death_inspection_record_private_capital;
	private String death_inspection_record_unit_service;
	...
	private String death_inspection_record_site_profile;
	private String death_inspection_record_death_clothing;
	private String death_inspection_record_handover_of_goods;
	private String death_inspection_record_receiver_goods;
	private String death_inspection_record_mark;
	private String death_inspection_record_autopsy_surface_table_test;
	private String death_inspection_record_autopsy_surface_table_test_recorder;
	private String death_inspection_record_autopsy_surface_table_test_recorder_time;
	private String death_inspection_record_autopsy_table_test_picture1;
	private String death_inspection_record_autopsy_table_test_picture2;
	private String death_inspection_record_autopsy_table_test_picture3;
	private String death_inspection_record_anatomic_test;
	private String death_inspection_record_anatomic_time;
	private String death_inspection_record_anatomic_place;
	private String death_inspection_record_autopsy_table_test_photographer;
	private String death_inspection_record_autopsy_table_test_video;
	private String death_inspection_record_autopsy_table_test_recorder;
	private String death_inspection_record_autopsy_table_test_recorder_time;
	private String death_inspection_record_anatomy_picture1;
	private String death_inspection_record_anatomy_picture2;
	private String death_inspection_record_anatomy_picture3;
	private String death_inspection_record_gmt_create;
	private String death_inspection_record_gmt_modified;

	@Override
	public String toString() {
		return "xsjsglxt_death_inspection_record [xsjsglxt_death_inspection_record_id=" + xsjsglxt_death_inspection_record_id + ", death_inspection_record_belong_entrustment_book="
				+ death_inspection_record_belong_entrustment_book + ", death_inspection_record_undertake_personnel=" + death_inspection_record_undertake_personnel
				+ ", death_inspection_record_phone=" + death_inspection_record_phone + ", death_inspection_record_death_name=" + death_inspection_record_death_name
				+ ", death_inspection_record_death_sex=" + death_inspection_record_death_sex + ", death_inspection_record_death_birth_date="
				...
				+ ", death_inspection_record_autopsy_table_test_picture1=" + death_inspection_record_autopsy_table_test_picture1
				+ ", death_inspection_record_autopsy_table_test_picture2=" + death_inspection_record_autopsy_table_test_picture2
				+ ", death_inspection_record_autopsy_table_test_picture3=" + death_inspection_record_autopsy_table_test_picture3 + ", death_inspection_record_anatomic_test="
				+ death_inspection_record_anatomic_test + ", death_inspection_record_anatomic_time=" + death_inspection_record_anatomic_time
				+ ", death_inspection_record_anatomic_place=" + death_inspection_record_anatomic_place + ", death_inspection_record_autopsy_table_test_photographer="
				+ death_inspection_record_autopsy_table_test_photographer + ", death_inspection_record_autopsy_table_test_video=" + death_inspection_record_autopsy_table_test_video
				+ ", death_inspection_record_autopsy_table_test_recorder=" + death_inspection_record_autopsy_table_test_recorder
				+ ", death_inspection_record_autopsy_table_test_recorder_time=" + death_inspection_record_autopsy_table_test_recorder_time
				+ ", death_inspection_record_anatomy_picture1=" + death_inspection_record_anatomy_picture1 + ", death_inspection_record_anatomy_picture2="
				+ death_inspection_record_anatomy_picture2 + ", death_inspection_record_anatomy_picture3=" + death_inspection_record_anatomy_picture3
				+ ", death_inspection_record_gmt_create=" + death_inspection_record_gmt_create + ", death_inspection_record_gmt_modified=" + death_inspection_record_gmt_modified
				+ "]";
	}
	...
	public void setDeath_inspection_record_belong_entrustment_book(String death_inspection_record_belong_entrustment_book) {
	...
	public void setDeath_inspection_record_inspect_ambient_temperature(String death_inspection_record_inspect_ambient_temperature) {
	...
	public void setDeath_inspection_record_autopsy_surface_table_test(String death_inspection_record_autopsy_surface_table_test) {
		this.death_inspection_record_autopsy_surface_table_test = death_inspection_record_autopsy_surface_table_test;
	}

	public void setDeath_inspection_record_autopsy_surface_table_test_recorder(String death_inspection_record_autopsy_surface_table_test_recorder) {
	...
	public void setDeath_inspection_record_autopsy_surface_table_test_recorder_time(String death_inspection_record_autopsy_surface_table_test_recorder_time) {
	...
	public void setDeath_inspection_record_autopsy_table_test_picture1(String death_inspection_record_autopsy_table_test_picture1) {
		this.death_inspection_record_autopsy_table_test_picture1 = death_inspection_record_autopsy_table_test_picture1;
	}

	public void setDeath_inspection_record_autopsy_table_test_picture2(String death_inspection_record_autopsy_table_test_picture2) {
		this.death_inspection_record_autopsy_table_test_picture2 = death_inspection_record_autopsy_table_test_picture2;
	}

	public void setDeath_inspection_record_autopsy_table_test_picture3(String death_inspection_record_autopsy_table_test_picture3) {
	...
	public void setDeath_inspection_record_autopsy_table_test_photographer(String death_inspection_record_autopsy_table_test_photographer) {
		this.death_inspection_record_autopsy_table_test_photographer = death_inspection_record_autopsy_table_test_photographer;
	}

	public void setDeath_inspection_record_autopsy_table_test_video(String death_inspection_record_autopsy_table_test_video) {
		this.death_inspection_record_autopsy_table_test_video = death_inspection_record_autopsy_table_test_video;
	}

	public void setDeath_inspection_record_autopsy_table_test_recorder(String death_inspection_record_autopsy_table_test_recorder) {
		this.death_inspection_record_autopsy_table_test_recorder = death_inspection_record_autopsy_table_test_recorder;
	}

	public void setDeath_inspection_record_autopsy_table_test_recorder_time(String death_inspection_record_autopsy_table_test_recorder_time) {
