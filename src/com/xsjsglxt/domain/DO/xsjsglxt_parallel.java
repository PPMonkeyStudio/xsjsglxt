...
public class xsjsglxt_parallel {
	...
	public xsjsglxt_parallel(String xsjsglxt_parallel_id, String parallel_num, String parallel_casename,
			String parallel_person, String parallel_date, String parallel_breakecaseSituation,
			String parallel_accordingAddress, String parallel_makeMeans, String parallel_makeTarget,
			String parallel_makeTime, String parallel_skillMerge, String parallel_othermakePoint,
			String parallel_gmt_create, String parallel_gmt_modified) {
	...
	public String toString() {
		return "parallel [xsjsglxt_parallel_id=" + xsjsglxt_parallel_id + ", parallel_num=" + parallel_num
				...
				+ ", parallel_date=" + parallel_date + ", parallel_breakecaseSituation=" + parallel_breakecaseSituation
				+ ", parallel_accordingAddress=" + parallel_accordingAddress + ", parallel_makeMeans="
				+ parallel_makeMeans + ", parallel_makeTarget=" + parallel_makeTarget + ", parallel_makeTime="
				+ parallel_makeTime + ", parallel_skillMerge=" + parallel_skillMerge + ", parallel_othermakePoint="
				+ parallel_othermakePoint + ", parallel_gmt_create=" + parallel_gmt_create + ", parallel_gmt_modified="
				+ parallel_gmt_modified + "]";
	}
