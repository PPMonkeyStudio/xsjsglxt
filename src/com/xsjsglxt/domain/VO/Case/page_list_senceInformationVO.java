...
public class page_list_senceInformationVO {
	...
	public String toString() {
		return "page_list_senceInformationVO [pageIndex=" + pageIndex + ", totalRecords=" + totalRecords + ", pageSize="
				...
				+ HaveNextPage + ", start_time=" + start_time + ", stop_time=" + stop_time + ", case_totalCategory="
				+ case_totalCategory + ", case_sonCategory=" + case_sonCategory + ", case_classify=" + case_classify
