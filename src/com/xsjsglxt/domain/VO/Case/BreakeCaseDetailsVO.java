...
public class BreakeCaseDetailsVO {
	...
	/**
	 * @param breakeCase the breakeCase to set
	 */
	...
	/**
	 * @param suspectList the suspectList to set
	 */
	...
	public String toString() {
		return "breakeCaseDetailsVO [breakeCase=" + breakeCase + ", suspectList=" + suspectList + "]";
	}
