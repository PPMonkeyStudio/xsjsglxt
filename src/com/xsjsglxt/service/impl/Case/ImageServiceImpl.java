...
public class ImageServiceImpl implements ImageService {
	...
	public page_list_imageInformationVO VO_ImageInformation_By_PageAndSearch(
		...
		for (xsjsglxt_picture picture : listPicture) {
			if (null != picture.getPicture_image() && !"".equals(picture.getPicture_image())) {
				image = imageDao.get_image_Byxsjsglxt_picture_id(picture);// 1
			}

			if (null != picture.getPicture_case() && !"".equals(picture.getPicture_case())) {
	...
	public ImageInformationDTO ImageInformationOne(xsjsglxt_image image, xsjsglxt_picture picture) {
		 ...
		 * imageDao.getImageBypictureId(picture); }
		 * 
	...
	public void updatePicture(xsjsglxt_picture picture) {
		// TODO Auto-generated method stub
		// xsjsglxt_picture
		// oldpicture=imageDao.getImageBypictureId(xsjsglxt_image_id);
