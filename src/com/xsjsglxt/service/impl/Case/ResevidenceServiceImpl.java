	...
	public page_list_ResevidenceInformationVO VO_Resevidenceformation_By_PageAndSearch(
		...
		for (xsjsglxt_resevidence resevidence : resevidenceList) {
			...
			if (page_list_ResevidenceInformation.getResevidence_extractPerson() != null
				...
				resevidence.setResevidence_extractPerson(resevidence.getResevidence_extractPerson()
						.replaceAll(resevidence.getResevidence_extractPerson(), "<span style='color: #ff5063;'>"
								+ resevidence.getResevidence_extractPerson().trim() + "</span>"));
			}
