...
public boolean removeResevidenceInformationList(List<String> useResevidenceInformationNumList) {
	...
	for (String Resevidence_id : useResevidenceInformationNumList) {
		...
		flag = resevidenceDao.deleteResevidenceById(resevidence.getXsjsglxt_resevidence_id());// 物证
		flag = resevidenceDao.deleteCirculationById(resevidence.getXsjsglxt_resevidence_id());// 物证流转信息
