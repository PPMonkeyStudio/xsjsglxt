...
public class ParallelDaoImpl implements ParallelDao {
	...
	public int getCountParallelInformationByPage(page_list_parallelInformationVO page_list_parallelInformation) {
		...
		if (page_list_parallelInformation.getStop_time() != null
				&& page_list_parallelInformation.getStop_time().trim().length() > 0) {
	...
	public xsjsglxt_parallel getparallelById(xsjsglxt_parallel parallel) {
		...
		String hql = "from xsjsglxt_parallel parallel where parallel.xsjsglxt_parallel_id='"
				+ parallel.getXsjsglxt_parallel_id() + "'";
	...
	public List<xsjsglxt_case> getcaseByparallelId(xsjsglxt_parallel parallel) {
		// TODO Auto-generated method stub
		Session session = getSession();
		String hql = "select case1 from xsjsglxt_case case1 where case1.case_parallel='"
				+ parallel.getXsjsglxt_parallel_id() + "'";
		Query query = session.createQuery(hql);
