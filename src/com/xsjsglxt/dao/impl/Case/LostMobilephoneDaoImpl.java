...
public class LostMobilephoneDaoImpl implements LostMobilephoneDao {
	...
	public xsjsglxt_case getCaseByxsjsglxt_lost_mobilephone_id(xsjsglxt_lost_mobilephone lost_mobilephone) {
		...
		String hql = "from xsjsglxt_case case1 where case1.xsjsglxt_case_id='"
				+ lost_mobilephone.getLost_mobilephone_case() + "'";
	...
	public xsjsglxt_lost_mobilephone getLostMobiephoneById(xsjsglxt_lost_mobilephone lost_mobilephone) {
		...
		String hql = "from xsjsglxt_lost_mobilephone lost_mobilephone where lost_mobilephone.xsjsglxt_lost_mobilephone_id='"
				+ lost_mobilephone.getXsjsglxt_lost_mobilephone_id() + "'";
	...
	public boolean deleteLost_mobilephoneById(String xsjsglxt_lost_mobilephone_id) {
		// TODO Auto-generated method stub
		Session session = getSession();
		String hql = "delete from xsjsglxt_lost_mobilephone where xsjsglxt_lost_mobilephone_id='"
				+ xsjsglxt_lost_mobilephone_id + "'";
		Query query = session.createQuery(hql);
		query.executeUpdate();
		return true;
	}
